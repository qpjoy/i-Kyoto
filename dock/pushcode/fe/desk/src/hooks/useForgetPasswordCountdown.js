...
import { setForgetPasswordTimer, setTimer } from "../features/Account/accountSlice";

export const useForgetPasswordCountdown = (ms = 1000) => {
  const counter = useSelector((state) => state.account.forget.timer);
  ...
  function setCountDown() {
    dispatch(setForgetPasswordTimer(counter - 1));
  }
